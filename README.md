...
每天清晨 08:00，Google Apps Script 自動抓取 AI 影音相關新聞（RSS / Tavily / Reddit），經 Claude API 三層處理（Haiku 過濾、Sonnet 評分摘要、Opus 寫觀點），寫入 Google Sheets。網站從 Sheets 即時讀取，8 點開站就看到當日內容。
